...
public class DeployablePlacer extends Item {
	private static final Predicate<Entity> RIDERS = EntityPredicates.EXCEPT_SPECTATOR.and(Entity::canHit);
	private final String deployableID;

	public DeployablePlacer(Settings settings, String deployableID) {
		super(settings);
	...
	public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
		...
		if(((HitResult) hitResult).getType() == HitResult.Type.BLOCK) {
			DeployableEntity boatEntity = this.createEntity(world, itemStack, user, hitResult);
	...
	private DeployableEntity createEntity(World world, ItemStack stack, PlayerEntity player, HitResult hitResult) {

		return new DeployableEntity(deployableID, stack, world, hitResult.getPos());
	}
}
