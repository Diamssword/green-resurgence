...
public class ItemTagGenerator extends FabricTagProvider.ItemTagProvider {
	...
	protected void configure(RegistryWrapper.WrapperLookup arg) {
		...
		getOrCreateTagBuilder(DURABILITY).add(Shields.specialRenderRegister.toArray(new Item[0]));
		getOrCreateTagBuilder(SHIELD).add(Shields.specialRenderRegister.toArray(new Item[0]));
	}
}
