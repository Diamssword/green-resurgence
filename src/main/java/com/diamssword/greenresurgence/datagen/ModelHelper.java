...
public class ModelHelper {
    ...
    public TextureKey[] getTextureKeysFor(GenericBlockSet.ModelType type)
    {
        switch (type)
        {
            case SIMPLE : return new TextureKey[]{TextureKey.ALL};

            case PILLAR, INVERSED_PILLAR : return new TextureKey[]{TextureKey.END, TextureKey.SIDE};

            case COMPOSTER : return new TextureKey[]{ TextureKey.PARTICLE, TextureKey.SIDE,TextureKey.TOP,TextureKey.BOTTOM,TextureKey.INSIDE};

            case MACHINE : return new TextureKey[]{ TextureKey.TOP, TextureKey.SIDE, TextureKey.FRONT, TextureKey.BOTTOM};
            case BOTOMLESS_MACHINE : return new TextureKey[]{TextureKey.TOP, TextureKey.SIDE, TextureKey.FRONT};
            case TWO_TEXTURED_MACHINE :return new TextureKey[]{TextureKey.SIDE, TextureKey.FRONT};
            case SLAB,SLAB_3TEX:  return new TextureKey[]{ TextureKey.FRONT, TextureKey.SIDE, TextureKey.BACK};
            case CARPET,LADDER: return new TextureKey[]{ TextureKey.PARTICLE};
        }
