...
public class Attributes {
	...
	public static final EntityAttribute MAX_CONTAMINATION = register("max_contamination", new ClampedEntityAttribute("attribute.name.green_resurgence.max_contamination", 100, 1D, 1024.0D).setTracked(true));
