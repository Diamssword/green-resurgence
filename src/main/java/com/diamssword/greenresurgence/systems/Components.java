...
public class Components implements EntityComponentInitializer, WorldComponentInitializer, ChunkComponentInitializer {
	...
	public static final ComponentKey<ChunkSnapshot> CHUNK_SNAPSHOT = ComponentRegistryV3.INSTANCE.getOrCreate(new Identifier("green_resurgence:chunk_snapshot"), ChunkSnapshot.class);
	...
	public void registerChunkComponentFactories(ChunkComponentFactoryRegistry registry) {
		registry.register(CHUNK_SNAPSHOT, ChunkSnapshot::new);
	}
}
