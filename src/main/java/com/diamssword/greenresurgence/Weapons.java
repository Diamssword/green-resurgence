...
public class Weapons implements ItemRegistryContainer {
	...
	public static final Item TRASH_SHIELD = new ShieldItem(defaut().maxDamage(500));
	public static final Item TRASH_SHIELD_GREEN = new ShieldItem(defaut().maxDamage(500));
