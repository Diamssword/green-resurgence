...
public class GenericBlocks {
    ...
    static {
        ...
        genericFurniture(diams, GenericBlockSet.BlockTypes.PILLAR, GenericBlockSet.Transparency.NOTFULL,"carton_petit",new String[]{"","_travers","_ouvert","_entreouvert"},null,null);
