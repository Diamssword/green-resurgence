...
public class GenericBlocks {
    ...
    static {
        ...
        //car
        diams.create(simpleList("car_", new String[]{"1_"}, new String[]{"tire_protection_full", "tire_protection_broken", "sidewalk", "front_bumper_right", "front_bumper_left"})).addSub(BlockType.PILLAR, ModelType.PILLAR, HitBox.SLAB).disableGen(true);
        diams.create(simpleList("car_", new String[]{"1_"}, new String[]{"front_right_gray", "front_left_gray"})).addSub(BlockType.PILLAR, ModelType.PILLAR, HitBox.STAIR).disableGen(true).setTransparency(Transparency.TRANSPARENT);
        diams.create(simpleList("car_", new String[]{"1_"}, new String[]{"chair_small_black"})).addSub(BlockType.PILLAR, ModelType.PILLAR, HitBox.CARPET_FIXED).disableGen(true).seat(CHAIR_SLAB);
