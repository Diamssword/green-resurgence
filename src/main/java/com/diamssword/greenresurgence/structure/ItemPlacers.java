...
public class ItemPlacers {
    ...
    public static final List<StructurePlacerInstance> multiblocksStructure=new ArrayList<>();
    public static StructurePlacerInstance rusted_car=multiblock("rusted_car",false);
    ...
    public static JigsawPlacerItem container=jigsaw("container",new Identifier("build","deco/containers/small/base"));
    ...
    public static StructurePlacerInstance multiblock(String name,boolean centered)
    {
        return multiblock(name,centered,new Identifier(GreenResurgence.ID+":placer/"+name));
    }
    public static StructurePlacerInstance multiblock(String name,boolean centered,Identifier structure)
    {
        StructurePlacerInstance item= new StructurePlacerInstance(name,structure,centered);
