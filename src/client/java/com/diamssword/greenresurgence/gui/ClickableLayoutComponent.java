...
public class ClickableLayoutComponent extends FlowLayout {
	...
	public ClickableLayoutComponent(Sizing horizontalSizing, Sizing verticalSizing, Algorithm algorithm) {
	...
	public static FlowLayout parse(Element element) {
		...
		return switch (element.getAttribute("direction")) {
			...
			case "ltr-text-flow" ->
					new ClickableLayoutComponent(Sizing.content(), Sizing.content(), Algorithm.LTR_TEXT);
