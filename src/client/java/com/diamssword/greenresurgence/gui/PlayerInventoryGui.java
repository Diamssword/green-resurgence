...
public class PlayerInventoryGui extends PlayerBasedGui<VanillaPlayerInvMokup> {
    ...
    private static Supplier<IconComponent> arrow_c=()-> (IconComponent) new IconComponent(GreenResurgence.asRessource("textures/gui/craft/arrow.png"),0,0,32,32,32,32).sizing(Sizing.fixed(12),Sizing.fixed(16));
