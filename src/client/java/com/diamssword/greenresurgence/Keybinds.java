...
public class Keybinds {
	...
	public static KeyBinding VEHICLE_KLAXON = registerOnTap(new KeyBinding(K + ".vehicle_sound", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_G, CAT), 10, () -> Channels.MAIN.clientHandle().send(new GuiPackets.KeyPress(GuiPackets.KEY.Klaxon)));
	public static KeyBinding VEHICLE_LIGHT = registerOnTap(new KeyBinding(K + ".vehicle_light", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_L, CAT), 10, () -> Channels.MAIN.clientHandle().send(new GuiPackets.KeyPress(GuiPackets.KEY.Flashlight)));
