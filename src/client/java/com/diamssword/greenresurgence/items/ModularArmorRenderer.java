...
public final class ModularArmorRenderer extends GeoArmorRenderer<ModularArmorItem> {
    ...
    public static RenderProvider  RendererProvider() {
        return new RenderProvider() {
            ...
            public BuiltinModelItemRenderer getCustomRenderer() {
                //Render pour l'item: pas ouf, voir pour un render custom fabric avec accés au contexte itemstack
                //accesoirement avec cet override le model de l'armure porté ce dup et part en couille
    ...
    public static class ModularArmorGeoModel<T extends GeoAnimatable> extends DefaultedGeoModel<T> {
        public ModularArmorGeoModel(Identifier assetSubpath) {this(assetSubpath,false);}
